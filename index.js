...
const apiPaths = {
    ...
    fetchMovieInfo : (id)=>`https://api.themoviedb.org/3/movie/${id}?api_key=${apiKey}`
}
...
function buildMoreInfoDiv(movieId){
    ...
    .then(res => {
        ...
        res.production_companies.forEach((item)=>{
        ...
        <div class="more-info-banner-section">
            <img class="more-info-banner" src="${imgPath}${res.backdrop_path}" alt="">
            <div class="more-info-title">
                <h2>${res.tagline}</h2>
            </div>
            <div class="more-info-close-btn movie-item-action-button-2">
    ...
    <div class="banner_fadebottom more-info-fadebottom">

    </div>
    <div class="more-info-movie-content">
        <div class="more-info-movie-details">
            <div class="more-info-movie-details-left">
            <p>Duration - 225 Mins Released on : ${res.release_date}</p>
            <div class="more-info-movie-releaseDetails">
                <div class="movie-item-rating">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="ipc-icon ipc-icon--star-border sc-e3b78b2c-4 ieNPZr" viewBox="0 0 24 24" fill="currentColor" role="presentation"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19.65 9.04l-4.84-.42-1.89-4.45c-.34-.81-1.5-.81-1.84 0L9.19 8.63l-4.83.41c-.88.07-1.24 1.17-.57 1.75l3.67 3.18-1.1 4.72c-.2.86.73 1.54 1.49 1.08l4.15-2.5 4.15 2.51c.76.46 1.69-.22 1.49-1.08l-1.1-4.73 3.67-3.18c.67-.58.32-1.68-.56-1.75zM12 15.4l-3.76 2.27 1-4.28-3.32-2.88 4.38-.38L12 6.1l1.71 4.04 4.38.38-3.32 2.88 1 4.28L12 15.4z"></path></svg> ${res.vote_average}
                </div>
